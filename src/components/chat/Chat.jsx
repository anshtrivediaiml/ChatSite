    ...
    <div className='chat'>
      ...
      <div className='bottom'>
       ...
       <img src="./mic.png"/>
        ...
        <input type="text" placeholder={isCurrentUserBlocked || isReceiverBlocked?"You cannot send a message":'Type a message...'} value={text} onChange={(e)=>setText(e.target.value)}
